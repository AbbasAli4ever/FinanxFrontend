      ...
      <div className="flex flex-col items-center justify-between grow lg:flex-row lg:px-6">
        ...
        >
          <div className="flex items-center gap-2 2xsm:gap-3">
            ...
            <Link
              href="/users"
              className="inline-flex items-center gap-2 rounded-lg border border-brand-500 bg-brand-500 px-3 py-2 text-sm font-medium text-white transition-colors hover:bg-brand-600 hover:border-brand-600 dark:border-brand-600 dark:bg-brand-600 dark:hover:bg-brand-700 dark:hover:border-brand-700"
            >
              <svg
                width="16"
                height="16"
