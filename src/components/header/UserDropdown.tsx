...
export default function UserDropdown({ variant = "header" }: UserDropdownProps) {
  ...
  const dropdownContent = (
    <>
      ...
      <ul className="flex flex-col gap-1 pt-4 pb-3 border-b border-gray-200 dark:border-gray-700">
        <li>
          <DropdownItem
            ...
            tag="a"
            href="/profile"
            className="flex items-center gap-3 px-3 py-2 font-medium text-gray-700 rounded group text-theme-sm hover:bg-gray-50 hover:text-gray-900 dark:text-gray-400 dark:hover:bg-white/5 dark:hover:text-gray-300 transition-colors duration-100"
          >
      ...
      <button
        onClick={logout}
        className="flex w-full items-center gap-3 px-3 py-2 mt-3 font-medium text-gray-700 rounded group text-theme-sm hover:bg-gray-50 hover:text-gray-900 dark:text-gray-400 dark:hover:bg-white/5 dark:hover:text-gray-300 transition-colors duration-100"
      >
  ...
  if (variant === "sidebar") {
    return (
      <div className="relative w-full">
        ...
        >
          <span className="flex h-8 w-8 items-center justify-center rounded-full bg-brand-100 text-[11px] font-bold text-brand-700 dark:bg-brand-900/30 dark:text-brand-300 transition-colors duration-150 group-hover:bg-brand-200 dark:group-hover:bg-brand-800/40">
            {initials}
          </span>
        ...
        <Dropdown
          ...
          className="absolute left-full bottom-0 ml-2 flex w-[220px] flex-col rounded-lg border border-gray-200 bg-white p-3 shadow-theme-lg dark:border-gray-700 dark:bg-gray-800"
        >
          {dropdownContent}
        </Dropdown>
      </div>
  ...
  return (
    <div className="relative">
      ...
      >
        <span className="mr-3 flex h-8 w-8 items-center justify-center rounded-full bg-brand-500 text-[11px] font-bold text-white">
          {initials}
        </span>
      ...
      <Dropdown
        isOpen={isOpen}
        onClose={closeDropdown}
        className="absolute right-0 mt-[17px] flex w-[240px] flex-col rounded-lg border border-gray-200 bg-white p-3 shadow-theme-lg dark:border-gray-700 dark:bg-gray-800"
      >
        {dropdownContent}
      </Dropdown>
    </div>
