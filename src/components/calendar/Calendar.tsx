...
const createInitialEvents = (): CalendarEvent[] => {
  ...
  return [
    ...
    },
    {
      id: "3",
      title: "Workshop",
      start: toIsoDate(dayAfterTomorrow),
      end: toIsoDate(threeDaysAfter),
  ...
  const handleAddOrUpdateEvent = () => {
    if (selectedEvent) {
      ...
      const newEvent: CalendarEvent = {
        id: eventCounter.current.toString(),
        title: eventTitle,
        start: eventStartDate,
        end: eventEndDate,
        allDay: true,
          ...
          <div className="mt-8">
            ...
            <div className="mt-6">
              ...
              <AppDatePicker
                ...
                onChange={(val) => setEventStartDate(val)}
                max={eventEndDate}
              />
            </div>
