  ...
  return (
    <div className="rounded-lg border border-gray-200 bg-white p-4 shadow-sm dark:border-gray-700 dark:bg-gray-900">
      <div className="mb-4 flex items-center gap-2">
        <div className="flex h-8 w-8 items-center justify-center rounded bg-success-50 dark:bg-success-900/20">
        ...
        <h3 className="text-[14px] font-semibold text-gray-900 dark:text-white">Top Customers</h3>
      </div>
        ...
        <>
          <ResponsiveContainer width="100%" height={220}>
            <BarChart data={chartData} margin={{ top: 5, right: 10, left: 10, bottom: 5 }}>
              ...
              <Bar dataKey="Revenue" fill="#6A89A7" radius={[4, 4, 0, 0]} maxBarSize={24} />
            ...
            {data.customers.slice(0, 5).map((c, i) => (
              <div key={c.customerId} className="flex items-center justify-between text-xs">
                <div className="flex items-center gap-2">
                  <span className="flex h-5 w-5 items-center justify-center rounded bg-brand-100 text-[10px] font-bold text-brand-700 dark:bg-brand-900/30 dark:text-brand-300">
                    {i + 1}
                  </span>
