  ...
  return (
    <div className="rounded-2xl border border-gray-200 bg-white p-5 shadow-sm dark:border-gray-700 dark:bg-gray-900">
      <div className="mb-4 flex items-center gap-2">
        ...
        <h3 className="text-base font-semibold text-gray-900 dark:text-white">Invoice Analytics</h3>
      </div>
        ...
        <>
          ...
          <div className="mt-3 grid grid-cols-2 gap-3 border-t border-gray-100 pt-3 dark:border-gray-700/60">
            <div className="rounded-xl bg-gray-50 p-3 dark:bg-gray-800/60">
              ...
              <p className="text-lg font-bold text-gray-900 dark:text-white">{fmt(data.totalInvoiced)}</p>
            </div>
            <div className="rounded-xl bg-success-50/60 p-3 dark:bg-success-900/20">
              <p className="text-[10px] uppercase tracking-wide text-success-600 dark:text-success-400">Collected</p>
              <p className="text-lg font-bold text-success-700 dark:text-success-300">{fmt(data.totalCollected)}</p>
            </div>
            ...
            <div className="rounded-xl bg-brand-50/60 p-3 dark:bg-brand-900/20">
              <p className="text-[10px] uppercase tracking-wide text-brand-600 dark:text-brand-400">Collection Rate</p>
              <p className="text-lg font-bold text-brand-700 dark:text-brand-300">{data.collectionRate.toFixed(1)}%</p>
            </div>
          </div>
        </>
      )}
