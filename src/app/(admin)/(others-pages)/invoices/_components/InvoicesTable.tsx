              ...
              return (
                ...
                >
                  ...
                  <TableCell className="px-4 py-3 text-center">
                    <Badge
                      size="sm"
                      color={statusBadgeColor[inv.status] || "light"}
                      variant="light"
                    >
                      {inv.statusInfo.label}
                    </Badge>
                  </TableCell>
