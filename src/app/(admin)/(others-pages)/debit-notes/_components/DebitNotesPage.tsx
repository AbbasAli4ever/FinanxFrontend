  ...
  const fetchDebitNotes = useCallback(async () => {
    ...
    try {
      const data = await debitNotesService.getDebitNotes(
        { status: statusFilter || undefined, search: searchFilter || undefined, dateFrom: dateFrom || undefined, dateTo: dateTo || undefined, sortBy: "debitNoteDate", sortOrder: "desc", page: pagination.page.toString(), limit: pagination.limit.toString() },
        token
      );
