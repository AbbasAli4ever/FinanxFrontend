...
const CreateExpenseModal: React.FC<CreateExpenseModalProps> = ({
  ...
  // Expense number is auto-generated by the backend on create.
  // Only send it if the user explicitly types a custom number.
      ...
      await expensesService.createExpense(
        {
          ...
          // expenseNumber is system-generated — never send from client
